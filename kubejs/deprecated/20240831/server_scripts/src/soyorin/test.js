...
//     const { source, entity, entity: { type: eType, block: { x: dx, y: dy, z: dz } }, server, level, player } = event;
//     if (source.actual.type === 'minecraft:player') {
//         server.tell(`受伤的实体: ${eType} 坐标: <${dx},${dy},${dz}>`);
//         /**
//          * 药水效果的id
//          * 持续时间 单位tick 20tick = 1秒
//          * 等级 0为最低级(游戏里的1级)
//          * 忘了
//          * false无粒子效果 true有
//          * 忘了
//          */
//         const MobEffectInstance = new $MobEffectInstance('minecraft:night_vision', 100, 0, true, true, true);
//         entity.addEffect(MobEffectInstance);
//     }
//     /**
//      * 事件里的玩家 当该值是null或undefined会被假定为false
//      */
//     if (player) {
